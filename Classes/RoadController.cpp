...
bool RoadController::__attachLane(int to_where) {
	...
	auto act4_2 = CallFunc::create(CC_CALLBACK_1(bindRoadController::makeNewRoad_callback, this));
...
void RoadController::removeCurrentRoad_callback(Ref *spr_cur_road) {
...
void RoadController::makeNewRoad_callback(Ref *spr_cur_road) {
